    ...
    def collect(self, _) -> Status:
        ...
        try:
            ...
            for cluster_quota in cluster_resource_quotas['items']:
                labels = {**cluster_global_labels}
                labels['name'] = cluster_quota['metadata']['name']
